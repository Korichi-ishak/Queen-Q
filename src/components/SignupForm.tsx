...
export const SignupForm: React.FC<SignupFormProps> = ({ drawnCard, isVisible, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-royal-purple/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-royal-purple/95 border border-imperial-gold/30 rounded-2xl p-8 max-w-md w-full shadow-2xl">
        ...
        {isSuccess ? (
          ...
          <div className="text-center">
            <div className="mb-4">
              <div className="w-16 h-16 bg-imperial-gold/20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-rose-champagne font-inter">
                Vous êtes maintenant sur la liste d'attente royale. Surveillez votre boîte email !
              </p>
            </div>
          </div>
        ) : (
